using System.IO;
using UtilityTools.MP3Player.Wave.FileFormats.MP3;
using UtilityTools.MP3Player.Wave.WaveFormats;
using UtilityTools.MP3Player.Wave.WaveStreams;
using UtilityTools.MP3Player.Wave.WinMM;

namespace UtilityTools.MP3Player
{
    /// <summary>
