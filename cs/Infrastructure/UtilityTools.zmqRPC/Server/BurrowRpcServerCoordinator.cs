...
namespace Burrow.RPC
{
    ...
    public class BurrowRpcServerCoordinator<T> : IRpcServerCoordinator where T : class
    {
        ...
        bool logMessages;
        private string connectionStringCommands;
        ...
        public BurrowRpcServerCoordinator(T realInstance, string connectionStringCommands, bool logMessages)
        {
            ...
            this.connectionStringCommands = connectionStringCommands;
        ...
        void Run()
        {
            while (running)
            {
                ...
                if (logMessages)
                {
                    WriteColorLine(connectionStringCommands, ConsoleColor.Yellow);
                    Console.WriteLine(string.Format(" Server Rcvd: {0}",
                        jsonRequest));
                }
