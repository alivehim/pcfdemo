...
namespace Burrow.RPC
{
    internal class RpcClientInterceptor : IInterceptor
    {
        ...
        private readonly string _connectionStringCommands;
        logDelegate log;

        ObjectPool<RpcConnect> objectPool;
        ...
        {
            _connectionStringCommands = connectionStringCommands;
        }
        ...
        public RpcClientInterceptor(string connectionStringCommands, logDelegate log, params IMethodFilter[] methodFilters)
        {
            ...
            objectPool = new ObjectPool<RpcConnect>(25, () => new RpcConnect(_connectionStringCommands));
        }
        ...
        public void Intercept(IInvocation invocation)
        {
            ...
            //using (var resource = objectPool.GetObject())
            //{
            //    // Using the resource...
            //    var response = resource.DownloadFile(request);
            ...
            using (var client = new RequestSocket(_connectionStringCommands))
            {
