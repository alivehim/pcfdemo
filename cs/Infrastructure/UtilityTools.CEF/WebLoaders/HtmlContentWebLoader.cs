...
namespace UtilityTools.CEF.WebLoaders
{
    public class HtmlContentWebLoader
    {
        #region Fields
        ...
        private async Task<bool> MainAsync(string cachePath, double zoomLevel)
        {
            ...
            browser.RequestHandler = new HtmlContentRequestHandler(url);
