...
{
    /// <summary>
    /// https://markheath.net/post/detecting-mouse-hover-over-listbox
    /// </summary>
    public class MouseOverHelpers
    {
       ...
       DependencyProperty.RegisterAttached("MouseOverCommand", typeof(ICommand), typeof(MouseOverHelpers),
        ...
        private static void ExecuteCommand(object sender, bool parameter)
        {
            ...
            if (command.CanExecute(new object[] { sender, parameter }))
            {
                command.Execute(new object[] { sender, parameter });
            }
        }
