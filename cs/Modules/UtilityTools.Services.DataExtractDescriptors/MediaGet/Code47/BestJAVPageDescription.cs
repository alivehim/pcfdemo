...
{
    public class BestJAVPageDescription : BaseMediaPageDescription, IMediaPageDescriptor<MediaDataDescription>
    {
        private string XPATH = @"//*[@class='thumb-block full-width loop-video']";
        ...
        protected async override Task<IExtractResult<MediaDataDescription>> ProcessAsync()
        {
            ...
            if (!string.IsNullOrEmpty(html))
            {
                ...
                foreach (HtmlNode categoryNode in categoryNodeList)
                {
                    ...
                    var imageNode = categoryNode.SelectSingleNode(@".//a/div/div/div/img");
                    ...
                    data.Add(new MediaDataDescription
                    {
                        ...
                        ImageUrl = imageurl,
                        Url = url,
                        MediaType = MediaSymbolType.BestJAV,
                        Order = index,
                    });
                    index++;
                }
