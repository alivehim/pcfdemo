...
{
    public class DontBreakemePageDescription : BaseMediaPageDescription, IMediaPageDescriptor<MediaDataDescription>
    {
        ...
        public DontBreakemePageDescription(IEventAggregator eventAggregator, IMediaSymbolDBService mediaSymbolDBService)
        {
        ...
        protected async override Task<IExtractResult<MediaDataDescription>> ProcessAsync()
        {
            ...
            {
                var symbol = mediaSymbolDBService.GetMediaSymbol(MediaSymbolType.DontBreakeMe.ToString());
                ...
                foreach (HtmlNode categoryNode in categoryNodeList)
                {
                    ...
                    data.Add(new MediaDataDescription
                    {
                        ...
                        Order = index,
                        Url = url,
                        MediaType = MediaSymbolType.DontBreakeMe
                    });
                    index++;
                }
            }
