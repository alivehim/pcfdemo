...
{
    public class BBCPiePageDescription : BaseMediaPageDescription, IMediaPageDescriptor<MediaDataDescription>
    {
        ...
        public BBCPiePageDescription(IEventAggregator eventAggregator, IMediaSymbolDBService mediaSymbolDBService)
        {
            ...
            if (!string.IsNullOrEmpty(html))
            {
                ...
                foreach (HtmlNode categoryNode in categoryNodeList)
                {
                    ...
                    data.Add(new MediaDataDescription
                    {
                        ...
                        Order = index,
                        Url = url,
                        MediaType = MediaSymbolType.BBCPie
                    });
                    index++;
                }
            }
