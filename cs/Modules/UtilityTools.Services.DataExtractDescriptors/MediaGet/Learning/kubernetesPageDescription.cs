...
{
    public class kubernetesPageDescription : BaseMediaPageDescription, IGrabArtcleContent, IMediaPageDescriptor<MediaDataDescription>
    {
        private string XPATH = @"//*[@class='entry-content']/ol/li";
        ...
        public kubernetesPageDescription(IMediaSymbolDBService mediaSymbolDBService, IEventAggregator eventAggregator)
        {
                ...
                foreach (HtmlNode categoryNode in categoryNodeList)
                {
                    ...
                    if (innerNode != null)
                    {
                        ...
                        data.Add(new MediaDataDescription
                        {
                            Name = name,
                            Url = url,
                            MediaType = MediaSymbolType.kubernetes,
                            Order = index
                        });
                        index++;
                    }
